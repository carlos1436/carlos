        ...
        <ul class="nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <i class="bi bi-person-fill-gear h4" style="color: #f0de89;"></i>
                </a>
                <ul class="dropdown-menu dropdown-menu-end rounded-0">
                    ...
                    <li>
                        ...
                        <a class="dropdown-item" href="../student/edit_profile_student.php">
                            <i class="bi bi-pencil-square pe-2"></i>Edit Profile</a>
                    </li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>

...
<div class="container-fluid">
    ...
    <div class="my-2 text-start">
        <span><strong>Total Lecture Hours: </strong>
            <?= $row['total_lecture_hours'] ?>
        </span><br>
        <span><strong>Total Laboratory Hours: </strong>
            <?= $row['total_laboratory_hours'] ?>
        </span>
    </div>
    <hr>
    <div class="my-2">
                                        ...
                                        ");
                                            ...
                                            foreach ($sections as $index => $section) {
                                                ...
                                                <tr class='text-center'>
                                                    ...
                                                    <td>" . strip_tags($_POST["semester"]) . "</td>
                                                    <td>" . strip_tags($_POST["school_year"]) . "</td>
                                                </tr>
                                            ";
                                            }
